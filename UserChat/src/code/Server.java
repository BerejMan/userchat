...
class ServerSomthing extends Thread {
    ...
    private Socket socket; // principal socket
    private BufferedReader in; // reading
    private BufferedWriter out; // writing
            ...
            try {
                while (true) {
                    ...
                    for (ServerSomthing vr : Server.serverList) {
                        ...
                        //TBM - Sending only for ONE person TODO
                    }
                }
...
public class Server {
    ...
    public static final int PORT = 8080; //TODO work in internet
    public static LinkedList<ServerSomthing> serverList = new LinkedList<>(); // array of usr connections
